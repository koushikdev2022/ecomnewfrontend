    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs text-gray-400">{parseUserName?.user_type}</span>
        </span>
      ...
      >
        <ul className="flex flex-col gap-3 border-b border-stroke px-4 py-4">
          <li>
            <Link
              to="/profile"
              className="flex items-center gap-2 text-sm font-normal duration-300 ease-in-out text-[#2E2E2E] hover:text-[#009BF2]"
            >
        ...
        <button onClick={handleLogout} className="flex items-center gap-2 py-3 px-4 text-sm font-normal duration-300 ease-in-out text-[#2E2E2E] hover:text-[#009BF2]">
