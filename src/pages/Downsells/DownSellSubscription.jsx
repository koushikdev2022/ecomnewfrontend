...
const DownSellSubscription = ({ watch, register, selectCurrency, errors }) => {
  let limit_of_Quantity = watch("quantity");
  let trialPeriods = watch("trialPeriods");
  const monthlyPrice = watch("subscription_base_price");
  return (
    <>
      <div className="mb-5">
...
export default DownSellSubscription;
