...
import { createUpSellPricing } from "../../Reducer/UpSellSlice";
import { useForm } from "react-hook-form";
import UpsellSubscriptionForm from "./UpsellSubscriptionForm";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

export const UpSellPricing = ({ setShow, proId, onBack }) => {
  ...
  const getCurrencys = watch("currency");
  useEffect(() => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(createUpSellPricing(payload)).then((res) => {
  ...
  const handlePreviousPage = () => {
    setShow({ UpSellOption: true, UpSellPricing: false });
    onBack();
  };
  return (
    <>
          ...
          <div className="px-12">
            <div className="mb-6 flex items-center">
              ...
              <h2 className="text-black font-bold text-[28px]">
                Pricing options for your upsell
              </h2>
            </div>
                ...
                <div className="mb-5">
                  <div className="notify_section border border-[#48C7FF] p-8">
                    <p className="text-black">
                      This is a free product and your customer will not be
                      charged. The currency used will be that of the product tha
                      this upsell is attached to.
                    </p>
                  </div>
                </div>
              </>
